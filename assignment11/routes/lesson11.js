...
let role1 = "employee";
let hash1 = bcrypt.hashSync(password1, 10);
db.run("INSERT INTO users (username, password, role) VALUES (?, ?, ?)", [username1, hash1, role1]);

let username2 = "bob";
let password2 = "password2";
let role2 = "manager";
let hash2 = bcrypt.hashSync(password2, 10);
db.run("INSERT INTO users (username, password, role) VALUES (?, ?, ?)", [username2, hash2, role2]);

let username3 = "charlie";
let password3 = "password3";
let role3 = "employee";
let hash3 = bcrypt.hashSync(password3, 10);
db.run("INSERT INTO users (username, password, role) VALUES (?, ?, ?)", [username3, hash3, role3]);
